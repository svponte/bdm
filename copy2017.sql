...
IN_LAMINA_OVERLAY, IN_PROTETOR_AURICULAR, 
IN_MEDIDOR_GLICOSE, IN_MAQUINA_BRAILE, IN_SOROBAN, 
IN_MARCA_PASSO, IN_SONDA, IN_MEDICAMENTOS, 
...
FROM '/home/ppca/Downloads/MICRODADOS_ENEM_2017_utf8.csv'
WITH header = true 
AND delimiter = ';'
AND CHUNKSIZE=1
AND NULL='null'
