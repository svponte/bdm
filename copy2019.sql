...
TP_SIT_FUNC_ESC, IN_BAIXA_VISAO, IN_CEGUEIRA,
...
IN_VISAO_MONOCULAR, IN_OUTRA_DEF, IN_GESTANTE,
IN_LACTANTE, IN_IDOSO, IN_ESTUDA_CLASSE_HOSPITALAR,
IN_SEM_RECURSO, IN_BRAILLE, IN_AMPLIADA_24,
IN_AMPLIADA_18, IN_LEDOR, IN_ACESSO,
IN_TRANSCRICAO, IN_LIBRAS, IN_TEMPO_ADICIONAL,
...
IN_SOROBAN, IN_MARCA_PASSO, IN_SONDA,
IN_MEDICAMENTOS, IN_SALA_INDIVIDUAL, IN_SALA_ESPECIAL,
IN_SALA_ACOMPANHANTE, IN_MOBILIARIO_ESPECIFICO, IN_MATERIAL_ESPECIFICO, 
IN_NOME_SOCIAL, CO_MUNICIPIO_PROVA, NO_MUNICIPIO_PROVA,
...
TP_LINGUA, TX_GABARITO_CN, TX_GABARITO_CH,
...
Q019, Q020, Q021, 
Q022, Q023, Q024, Q025)
FROM '/cassandra/csv/MICRODADOS_ENEM_2019_utf8.csv'
WITH header = true 
AND delimiter = ';'
AND CHUNKSIZE=1
AND NULL='null'
